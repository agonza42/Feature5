...
export const createTrackingEntry = (formData) => {
    ...
    const { todaysDate, breakfastCals, lunchCals, dinnerCals, snacksCals, exerciseCals } = formData; // Destructure the values
...
export const getById = (id) => {
  ...
  // READ operation - get all goals in Parse class TrackingEntry
